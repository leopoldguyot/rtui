...
**Windows:** install
[Rtools](https://cran.r-project.org/bin/windows/Rtools/) and run in a
modern terminal (Windows Terminal, PowerShell, or a recent cmd.exe with
VT enabled).
...
- `explained-example`: a full app walkthrough with step-by-step reactive
  flow.
- `reactivity-reference`: concise reference of the graph-based
  reactivity model.
